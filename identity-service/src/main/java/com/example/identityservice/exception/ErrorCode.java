...
public enum ErrorCode {
    ...
    CANT_CREATE_TOKEN(1014, "Cannot create token", HttpStatus.BAD_REQUEST),
    INVALID_PERMISSION_NAME(1015, "Name must be at {min}-{max} characters", HttpStatus.BAD_REQUEST),
    INVALID_PERMISSION_DESCRIPTION(1016,
            "Description must be at 0-{max} characters", HttpStatus.BAD_REQUEST),
    INVALID_ROLE_NAME(1017, "Name must be at {min}-{max} characters", HttpStatus.BAD_REQUEST),
    INVALID_ROLE_DESCRIPTION(1018,
            "Description must be at 0-{max} characters", HttpStatus.BAD_REQUEST),
    INVALID_EMAIL(1019, "Email is not in correct format", HttpStatus.BAD_REQUEST),
    ;
